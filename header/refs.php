        ...
        <div id="page-bgtop">
            <div id="page-bgbtm">
                <div id="content">
                    ...
                    <h1>PDFs:</h1>
                    <br/>
                    <a href="#" onclick="validatePass1()">Immersive worlds.pdf</a>
                    <a href="#" onclick="validatePass1()"><img id="ico" src="../images/PDF-icon-small-231x300-231x300.png"></a>
                    <p><i>The immersive worlds handbook</i><br/>
                        2013, <strong>Scott Lukas</strong></p> <br/>
                    <br/>
                    <a href="#" onclick="validatePass2()">The VR Book Sample.pdf</a>
                    <a href="#" onclick="validatePass2()"><img id="ico" src="../images/PDF-icon-small-231x300-231x300.png"></a>
                    <p><i>Human-Centered Design for virtual Reality</i><br/>
                        2014, <strong>Jason Jerald phd</strong></p> <br/>
                    <br>
                    <a href="#" onclick="validatePass3()">Crossroads Magazine</a>
                    <a href="#" onclick="validatePass3()"><img id="ico" src="../images/PDF-icon-small-231x300-231x300.png"></a>
                    <p><i>Computers and Art</i><br/>
                        spring 2018, <strong>Association for Computing Machinery</strong></p> <br/>
                    <br/>
                    <br/>
                    <h1>SOURCES:</h1>
                    <br/>
                    <!-- source -->
                    <?php
                    include '../sources/sourcePage1.php'
                    ?>
